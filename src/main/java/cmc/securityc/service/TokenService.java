package cmc.securityc.service;

import cmc.securityc.utils.*;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUser<?,?> loginUser) {
        ...
        Object userId = loginUser.getUserId();
    ...
    public <L extends LoginUser<K,T>,K,T> L getLoginUser(String token) {
        ...
        try {
            if (StringUtils.isNotEmpty(token)) {
                ...
                // 通过redis获取用户信息
                user = securitycCacheService.getCacheObject(getTokenKey(userkey));
                return user;
            }
    ...
    public void delLoginUser(String token) {
        if (StringUtils.isNotEmpty(token)) {
            String userkey = JwtUtils.getUserKey(token);
            securitycCacheService.deleteObject(getTokenKey(userkey));
        }
    }
    ...
    public void refreshToken(LoginUser<?,?> loginUser) {
        ...
        securitycCacheService.setCacheObject(userKey, loginUser, expireTime, TimeUnit.MINUTES);
    }
